defmodule WowtradeWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(WowtradeWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(WowtradeWeb.Gettext, "errors", msg, opts)
    end
  end
